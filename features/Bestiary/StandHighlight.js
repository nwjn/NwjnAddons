...
registerWhen(register("renderWorld", () => {
  ...
  while (i--) {
    ...
    const closest = World.getWorld().func_72839_b(stand.getEntity(), stand.getEntity().func_174813_aQ().func_72314_b(1, 1, 1)).filter(e => !(e instanceof EntityArmorStand.class))?.[0]
